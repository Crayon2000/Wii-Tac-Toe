...
INCLUDES	:=	source source/pngu source/grrlib source/grrmod source/fmt
...
#---------------------------------------------------------------------------------
LIBS	:=	-lturbojpeg -lpngu -lpng -lz -lfat -lwiiuse -lbte -lgrrmod -laesnd -logc -lm -lfreetype -lbz2 -lmxml
